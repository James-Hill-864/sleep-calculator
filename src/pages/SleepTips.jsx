  ...
  return (
    <>
      <Helmet>
        ...
        <script type="application/ld+json">{JSON.stringify({"@context":"https://schema.org","@type":"HowTo","name":"How to Fall Asleep Faster — 7 Science-Backed Tips","description":"Seven evidence-based strategies to fall asleep faster tonight.","step":[{"@type":"HowToStep","position":1,"name":"Lock in the same wake time every day","text":"Keep your wake time within a 30-minute window 7 days a week. Your circadian rhythm anchors to your wake time; consistency eliminates social jet lag."},{"@type":"HowToStep","position":2,"name":"Drop your room temperature to 65–68°F","text":"Set your thermostat to 65–68°F (18–20°C). Your core body temperature must drop ~1°C to initiate sleep onset; a warm room fights this process."},{"@type":"HowToStep","position":3,"name":"Cut all screens 45–60 minutes before bed","text":"Stop using phones and laptops 45–60 minutes before bed. Blue light suppresses melatonin by up to 50%."},{"@type":"HowToStep","position":4,"name":"Set a hard caffeine cutoff at 2 PM","text":"Stop consuming caffeine after 2 PM. With a 5–7 hour half-life, a 3 PM coffee still has half its caffeine circulating at 9 PM."},{"@type":"HowToStep","position":5,"name":"Build a 20-minute wind-down routine","text":"Create a consistent pre-bed routine: dim lights, light reading, light stretching. The sequence becomes a melatonin-triggering cue within two weeks."},{"@type":"HowToStep","position":6,"name":"Exercise — but finish 3 hours before bed","text":"Regular aerobic exercise increases deep sleep by up to 75 minutes per night. Finish any intense exercise at least 3 hours before bed."},{"@type":"HowToStep","position":7,"name":"Use your bed for sleep only","text":"Work at a desk. Watch TV on the couch. If you cannot fall asleep within 20 minutes, get up and return only when drowsy. This is stimulus control therapy."}]})}</script>
      </Helmet>
